namespace Org.BouncyCastle.Pqc.Math.Ntru.Polynomial
{
    public interface IPolynomial
    {
         ...
         */
        IntegerPolynomial Multiply(IntegerPolynomial poly2);
         ...
         * @return the product of the two polynomials
         */
        IntegerPolynomial Multiply(IntegerPolynomial poly2, int modulus);
         ...
         */
        BigIntPolynomial Multiply(BigIntPolynomial poly2);
    }
}